...
#    Updated: 2024/07/19 00:19:56 by yaidriss         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Source files
SRC = ircserv.cpp Client.cpp Server.cpp Channel.cpp commands/cmd.cpp commands/join1.cpp commands/topic.cpp commands/invite.cpp commands/utils.cpp commands/kick.cpp commands/mode.cpp commands/pass.cpp commands/nick.cpp commands/user.cpp commands/privmsg.cpp commands/quit.cpp
